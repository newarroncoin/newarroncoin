...
/**
  Arron GUI main class. This class represents the main window of the Arron UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ArronGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit ArronGUI(QWidget *parent = 0);
    ~ArronGUI();
