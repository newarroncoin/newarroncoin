...
void OptionsModel::Init()
{
    ...
    fAutoRedeemArron = settings.value("fAutoRedeemArron", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemArron:
            return fAutoRedeemArron;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemArron: return "AutoRedeemArron";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::ARC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemArron: {
            fAutoRedeemArron = value.toBool();
            settings.setValue("fAutoRedeemArron", fAutoRedeemArron);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemArron() { return fAutoRedeemArron; }
