...
int64_t CChainParams::GetProofOfWorkReward(int nHeight, int64_t nFees) const
{
    ...
    if (nHeight <= nLastPOWBlock)
        nSubsidy = (NetworkID() == CChainParams::TESTNET ? 0.1 : 0.4) * COIN;
...
public:
    CBaseChainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("main.ailuncoin.com",  "seed.ailuncoin.com"));
        vSeeds.push_back(CDNSSeedData("main1.ailuncoin.com",  "seed1.ailuncoin.com"));
        vSeeds.push_back(CDNSSeedData("main2.ailuncoin.com", "seed2.ailuncoin.com"));
        vSeeds.push_back(CDNSSeedData("main3.ailuncoin.com", "seed3.ailuncoin.com"));
        vSeeds.push_back(CDNSSeedData("main4.ailuncoin.com", "seed4.ailuncoin.com"));
    }
...
public:
    CMainParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS]      = list_of(100).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[SECRET_KEY]          = list_of(191).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[STEALTH_ADDRESS]     = list_of(122).convert_to_container<std::vector<unsigned char> >();
