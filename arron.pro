...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.arroncoin
    BOOST_LIB_SUFFIX=-mt
...
contains(ARRON_NEED_QT_PLUGINS, 1) {
    DEFINES += ARRON_NEED_QT_PLUGINS
...
# also add new translations to arron.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/arroncoin*.ts)
